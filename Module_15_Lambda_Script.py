...
def recommend_portfolio(intent_request):
    ...
    if age >= 65:
        return build_validation_result(
            False,
            "age",
            "You must be younger than 65 to open a retirement account.",
            )
    if investmentAmount < 5000:
        return build_validation_result(
            False,
            "investmentAmount",
            "To open a portfolio you must invest a minimum of $5,000.",
            )
    if riskLevel == "None":
        return build_validation_result(
            True,
            "riskLevel",
            "Your recommended portfolio mix is 100% bonds (AGG), 0% equities (SPY)",
            )
    if riskLevel == "Low":
        return build_validation_result(
            True,
            "riskLevel",
            "Your recommended portfolio mix is 60% bonds (AGG), 40% equities (SPY)",
            )
    if riskLevel == "Medium":
        return build_validation_result(
            True,
            "riskLevel",
            "Your recommended portfolio mix is 40% bonds (AGG), 60% equities (SPY)",
            )
    if riskLevel == "High":
        return build_validation_result(
            True,
            "riskLevel",
            "Your recommended portfolio mix is 20% bonds (AGG), 80% equities (SPY)",
            )
